...
export default function Experience() {
    ...
    const skills = {
        'Software skills': ['Python - Solid knowledge', 'C - Really good knowledge', 'C++ - Really good knowledge', 'Javascript - solid knowledge', 
                            'HTML/CSS - Pretty good knowledge', 'Databases - Solid knowledge', 'React.js - Pretty good knowledge', 'Node.js - Pretty good knowledge'],
        'Personal skills': ['Good under pressure', 'Team player', 'Communicative', 'Persistent', 'Always trying to improve myself'],
        'Language skills': ['Croatian', 'English'],
    }
    ...
    const PrintSkills = () => {
        const printSoftSkills = skills['Software skills'].map(el => <li>{el}</li>)
        const printPersonalSkills = skills['Personal skills'].map(el => <li>{el}</li>)
        const printLanguageSkills = skills['Language skills'].map(el => <li>{el}</li>)
        return(
            <>
                <a name="Skills"></a>
                <div className='Experience'>
